...
namespace Dashboard.Services.Parsers
{
    ...
    public class HtmlParser
    {
        ...
        private static Requirement BuildTaxResults(IList<Html> results)
        {
            ...
            tax.ExpiryDate = GetDate(results.Last(x => x.Text.Contains(TaxSearchText), TaxSearchText).Text);
        ...
        private static Requirement BuildMotResults(IList<Html> results)
        {
            ...
            tax.ExpiryDate = GetDate(results.Last(x => x.Text.Contains(MotSearchText), MotSearchText).Text);
