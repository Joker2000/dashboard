...
namespace Dashboard.Services.Parsers
{
    ...
    public class HtmlParser
    {
        ...
        /// The <see cref="object"/>.
        /// </returns>
        private static Requirement GetTaxResults(HtmlDocument document)
        {
            var results =
            ...
            var tax = BuildTaxResults(results);
        }

        private static Requirement BuildTaxResults(IEnumerable<object> results)
        {
