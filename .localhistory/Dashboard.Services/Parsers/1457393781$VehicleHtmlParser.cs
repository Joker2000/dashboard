...
namespace Dashboard.Services.Parsers
{
    ...
    public class VehicleHtmlParser : IHtmlParser
    {
        ...
        private static Vehicle BuildVehicleDetails(HtmlDocument document)
        {
            ...
            var regNumber = SearchFor(document.DocumentNode.Descendants(), "class", "registrationNumber").Single().InnerText;
        ...
        {
            return
                document.DocumentNode.Descendants().Where(x => x.Attributes[attribute] != null)
