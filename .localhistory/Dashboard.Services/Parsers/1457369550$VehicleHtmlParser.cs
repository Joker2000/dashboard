    ...
    public class VehicleHtmlParser
    {
        ...
        public void Parse(string html)
        {
            ...
            var vehicle = new Vehicle
                              {
                                  RoadTax = BuildResults(GetResults(document, ValidTaxHtmlClass), IsTaxedText, TaxSearchText),
        ...
        /// </returns>
        private static Requirement BuildResults(IList<Html> results, string isValidSearchText, string expiryDateSearchText)
        {
            ...
            tax.ExpiryDate = GetDate(results.Last(x => x.Text.Contains(expiryDateSearchText)).Text, expiryDateSearchText);
