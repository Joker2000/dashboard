...
namespace Dashboard.Services.Parsers
{
    ...
    public class VehicleHtmlParser : IHtmlParser
    {
        ...
        /// The VehicleDto make.
        /// </summary>
        private const string VehicleMake = "VehicleDto make";
        ...
        /// The colour.
        /// </summary>
        private const string Colour = "VehicleDto colour";
        ...
        /// The type approval.
        /// </summary>
        private const string TypeApproval = "VehicleDto type approval";
