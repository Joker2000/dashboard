...
namespace Dashboard.Services
{
    ...
    public class VehicleService : IVehicleService
    {
        ...
        /// The client.
        /// </summary>
        private readonly IWebClient<Vehicle> client;
        ...
        /// The client.
        /// </param>
        public VehicleService(IWebClient<Vehicle> client)
        {
            this.client = client;
        }
        ...
        {
            var response = this.client.MakeRequest("https://www.vehicleenquiry.service.gov.uk", vehicle);
            Mapper.Map<byte[], Vehicle>(response, vehicle);
