    ...
    public class WebClient : IWebClient
    {
        ...
        public bool MakeVehicleEnquiry(out string responseBody, string numberPlate, string manufacturer)
        {
            ...
            try
            {
                ...
                BuildPostStream(numberPlate, manufacturer, request);
            ...
            catch (WebException e)
            {
                if (e.Status == WebExceptionStatus.ProtocolError)
                {
                    ...
                    // TODO: Log response and exception here
                }
                else
                {
                    return false;
        ...
        private static void BuildPostStream(string numberPlate, string manufacturer, HttpWebRequest request)
        {
            var postBytes = System.Text.Encoding.UTF8.GetBytes(string.Format(Body, numberPlate, manufacturer));
